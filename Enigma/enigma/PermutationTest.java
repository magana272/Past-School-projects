...
public class PermutationTest {
    ...
    public void checkForwardTransform() {
        ...
        checkPerm("forward", UPPER_STRING, UPPER_STRING.substring(1)+ "A"); // FIXME - what string represents the result of permuting each letter?
    }
    ...
    public void checkBackwardTransform() {
        ...
        checkPerm("backward", UPPER_STRING,"Z" + UPPER_STRING.substring(0,25)); // FIXME - what string represents the result of permuting each letter?
    }
