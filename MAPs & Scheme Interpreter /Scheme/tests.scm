...
(+ (* 1 (* 1 1) ) 2)
;expect 3
(quote thisprojectwashard)
;expect thisprojectwashard
(cons '(2 3)(quote (1 2 2 3)))
;expect ((2 3) 1 2 2 3)
((lambda() 'weaklambdafunc))
;expect weaklambdafunc
(or #f #f #f 1 (define fun (lambda (x)( + 2 2))))
;expect 1
(or #f #f #f (define fun (lambda (x)( + 2 2))))
;expect fun
(fun 1)
;expect 4
(let((a 's)( b 'c)(c 'h)(d 'e)(e 'm)(f 'e!))
        (list a b c d e f ))
;expect (s c h e m e!)
(or #f ( and 1 3 (or #f 1) ))
;expect 1
